namespace ARTreasureHunt
{
    ...
    public class TrackingMonitor : MonoBehaviour
    {
        ...
        //UI Panel for displaying location related alerts
        [SerializeField] GameObject LocationMessagePanel;
